...
def get_FDA_code_from_image_base64(image_base64, include_subclass=True):
    ...
    # Openai Key
    openai.api_key="sk-proj-fcysG0y1Q0J004Vq8s26T3BlbkFJoC8B0w9vqVQTFHhAdJws"
    
    # Fetch industry data
    industry_csv_file_path = "/Users/roope/Desktop/Test 2/industry_api_result_data.csv"
    ...
    # Fetch class data
    class_csv_file_path = "/Users/roope/Desktop/Test 2/class_api_result_data.csv"
    class_csv = pd.read_csv(class_csv_file_path)
    class_data = class_csv.to_json(orient='records')
    # print("Class Data:", class_data)
    
    # Fetch subclass data
    subclass_csv_file_path = "/Users/roope/Desktop/Test 2/subclass_api_result_data.csv"
    ...
    # Fetch PIC data
    pic_csv_file_path = "/Users/roope/Desktop/Test 2/pic_api_result_data.csv"
    ...
    sub_class_code = response_subclass.choices[0].message.content
